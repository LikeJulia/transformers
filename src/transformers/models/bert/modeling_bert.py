...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        attention_probs = nn.functional.softmax(attention_scores + self.DAM_wrapper()[0], dim=-1)
        # attention_probs = nn.functional.softmax(attention_scores, dim=-1)*self.DAM_wrapper()[1]
